...
echo -e "\n📦 正在更新系统并安装依赖..."
brew update
brew install screen curl iptables git wget lz4 jq make gcc nano automake autoconf tmux htop libssl-dev libleveldb-dev tar clang bsdmainutils ncdu unzip
